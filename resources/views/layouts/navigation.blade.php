<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="shrink-0 flex items-center">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('microphone.index')" :active="request()->routeIs('microphone.*')">
                        Microphone
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('screen.index')" :active="request()->routeIs('screen.*')">
                        Screen
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('control.index')" :active="request()->routeIs('control.*')">
                Control
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('camera.index')" :active="request()->routeIs('camera.*')">
                Camera
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('microphone.index')" :active="request()->routeIs('microphone.*')">
                Microphone
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('screen.index')" :active="request()->routeIs('screen.*')">
                Screen
            </x-responsive-nav-link>
